...
Before contributing, please read and abide by our [Code of Conduct.](https://github.com/zyruks/astro-starter/docs/Code_of_conduct.MD) We take our code of conduct very seriously and expect all contributors to adhere to it.
...
1. 🔍 **Look for an issue to work on in the [GitHub issue tracker.](https://github.com/zyruks/astro-starter/issues)** If you can't find an issue that suits you, create a new issue. [Learn More](#finding-and-reporting-issues)
...
If you encounter a bug or have a feature request, you can report it by opening an issue on the [GitHub issue tracker.](https://github.com/zyruks/astro-starter/issues)
...
Including these details will help the maintainers of the project understand the issue and respond more effectively. Thank you for your contribution to the astro-starter project.
...
```
git remote add upstream https://github.com/zyruks/astro-starter
git pull upstream develop
```

The `git remote add` command is used to add a new remote repository to your local Git repository. In this case, `upstream` is the name of the remote repository being added and https://github.com/zyruks/astro-starter is the URL of the remote repository.
...
```
git checkout -b ZAS-XX-description develop
```
...
```
git push -u origin ZAS-XX-description
```
...
1. Go to the original Reward System repository on GitHub and click on the "Pull requests" tab. [Shortcut](https://github.com/zyruks/astro-starter/pulls)
2. Click on the "New pull request" button.
3. Select your branch as the "compare" branch and the develop branch as the "base" branch.
...
The title of your pull request should start with the issue identifier `[ZAS-XX]` followed by a short description of the change. For example:

```
[ZAS-12] Add new feature
[ZAS-456] Fix bug in rewards calculation
[ZAS-789] Update login page styling
```

The issue identifier `ZAS-XX` corresponds to the number of the issue that the pull request is addressing. If you're adding a new feature, make sure there's an open issue for it before creating a pull request.
...
We appreciate your contributions to the astro-starter project. Your time and effort help make the project better for everyone!
